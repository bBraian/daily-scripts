...
export default function Page() {
  ...
  function handleChangeSQLQuery(value: string) {
    ...
    if (typeFound) {
      setFormData((prev) => ({
        ...prev,
        scriptTypeId: typeFound.id.toString(),
      }));
    }
  }
        ...
        <CardHeader>
          <div className="flex flex-row items-center justify-between">
            <div>
              ...
              <CardDescription>
                Preencha o formulario para criar um script novo
              </CardDescription>
            </div>
            <Button
              type="button"
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid auto-rows-min gap-4 md:grid-cols-3">
              ...
              <div>
                ...
                <Select
                  name="scriptTypeId"
                  onValueChange={(value) => handleChange("scriptTypeId", value)}
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleChange("expectedReturnId", value)
                  }
                ...
                {errors.expectedReturn && (
                  <p className="text-red-500">{errors.expectedReturn}</p>
                )}
              </div>
            </div>
